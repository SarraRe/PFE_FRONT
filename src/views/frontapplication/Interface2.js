        ...
        <div>
            ...
            <div className={classes.background}>
                ...
                <Zoom right cascade collapse when={showTitle}>
                    <h1 className="title">Espace Revendeur</h1>
                </Zoom>
            </div>
            <div id="scrollTo">
                <div className={classes.background2}>
                    ...
                    <Fade right>
                        <Button style={{ color: "black", fontSize: 30,  background: '#ffcdd2',  border: 20 }} component={RouterLink} to="/reclamtionv">  Déposer réclamations  </Button>
                    </Fade>
                    <Fade left>
                        <Button style={{ color: "black", fontSize: 30, }} component={RouterLink} to="/MJP2">  Mettre à jour mon profil  </Button>
                    </Fade>
                    <Fade right>
                        <Button style={{ color: "black", fontSize: 30,  background: '#ffcdd2' }} component={RouterLink} to="/MdpRevendeur">  Changer mon mot de passe  </Button>
                    </Fade>
                    <Fade left>
                        <Button style={{ color: "black", fontSize: 30,  }} component={RouterLink} to="/VoirRecRevendeur">  Voir mes réclamations  </Button>
                    </Fade>
                    <Fade right>
